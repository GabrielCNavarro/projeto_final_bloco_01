...
public class Menu {
    ...
    public static void main(String[] args) {
        ...
        Organico og1 = new Organico(sabonetes.gerarId(), "Sabonete de Rosa Damascena", 1, 12.0f,
                "Extrato de Leite de Cabra e Mel");
        sabonetes.criarSabonete(og1);

        Vegano vg1 = new Vegano(sabonetes.gerarId(), "Sabonete Tea Tree", 2, 15.0f,
                "Óleo Essencial Tea Tree e extrato de Menta");
                ...
                case 1:
                    ...
                    switch (tipo) {
                        case 1:
                            ...
                            sabonetes.criarSabonete(new Organico(sabonetes.gerarId(), nome, tipo, preco,
                                    ingredOrganicos));
                            break;
                        case 2:
                            System.out.print("Digite o nome do Sabonete: ");
                            ...
                            sabonetes.criarSabonete(new Vegano(sabonetes.gerarId(), nome, tipo, preco,
                                    ingredVegetais));
                            break;
                    }
                    keyPress();
